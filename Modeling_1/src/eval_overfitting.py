...
#Script to check if we have overfitting
#tests shuffels everything random, trains the beste model, does predictions. 
# We want to see that the results are very bad, so we know our data is used right for training
